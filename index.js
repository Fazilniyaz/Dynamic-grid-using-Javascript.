...
var productList = [
    ...
    {
      id: "3",
      name: "Men Black Action Parkview Lifestyle",
      preview:
    ...
    {
      id: "4",
      name: "Women Black Solid Lightweight Leather",
      preview:
    ...
    {
      id: "9",
      name: "Gear IconX Black Cord-free Fitness",
      preview:
  ...
  var main1 = document.getElementById("main");
                        ...
                        var clothingText = document.querySelector(".clothingText");
                        var h2 = document.createElement("h2");
                         h2.innerText = "Clothing for Men and Women";
                         clothingText.appendChild(h2);
                         h2.classList.add("clothSectionHeader");
  
  
  

                                 var accessoriesText = document.querySelector(".accessoriesText");
                                   var h22 = document.createElement("h2");
                                    h22.innerText = "Accessories for Men and Women";
                                 accessoriesText.appendChild(h22);
                                     h22.classList.add("clothSectionHeader");

  
  
  var clothDiv = document.querySelector(".ClothingDiv");
  var assessoriesDiv = document.querySelector(".AccessoriesDiv");
  

  var clothInnerDiv = document.createElement("div");
  clothInnerDiv.classList.add("clothInnerDiv");
  ...
  for (var i = 0; i < productList.length; i++) {
    ...
    cardH3.classList.add("h5");

    var cardH4 = document.createElement("h4");
    cardH3.classList.add("h4");
    img.src = productList[i].preview;
      ...
      clothInnerDiv.appendChild(card);
  

      cardH3.innerText = productList[i].name;
      detailsDiv.appendChild(cardH3);
      card.appendChild(detailsDiv);
      clothInnerDiv.appendChild(card);
  

  cardH4.innerText = productList[i].brand;
  detailsDiv.appendChild(cardH4);
  card.appendChild(detailsDiv);
  clothInnerDiv.appendChild(card);
  

  cardH5.innerText =  ` Rs ${productList[i].price}`;
  detailsDiv.appendChild(cardH5);
  card.appendChild(detailsDiv);
  clothInnerDiv.appendChild(card);
  clothDiv.appendChild(clothInnerDiv);
      } 
        ...
        imgDiv.appendChild(img);
        card.appendChild(imgDiv);
        assessoriesDiv.appendChild(card);
